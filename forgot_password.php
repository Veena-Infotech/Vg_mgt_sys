                                ...
                                <div class="col mx-auto">
                                    <div class="auth-form-box p-4 text-center rounded shadow">
                                        ...
                                        <div class="step active" id="step1">
                                            <p class="text-body-tertiary mb-4">"Enter your email an otp will be sent to
                                                that email"</p>
                                            <div class="form-icon-container mb-5"><input
                                            ...
                                            <button class="btn btn-primary w-100" onclick="goToStep(2)">Send
                                                OTP</button>
                                        </div>
                                        ...
                                        <div class="step" id="step2">
                                            ...
                                            <input class="form-control mb-3" type="text" placeholder="Enter OTP" />
                                            <button class="btn btn-primary w-100" onclick="goToStep(3)">Verify
                                                OTP</button>
                                        </div>
