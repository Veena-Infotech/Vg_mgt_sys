...
<body>
            ...
            <div class="content" style="margin-top: -7%;">
                ...
                <div class="row gx-6 gy-3 mb-4 align-items-center">
                    <div class="col-auto">
                        ...
                        <h6>Admin or senior members can review each proposal below.</h6>
                    </div>
                    <div class="col-auto"><a class="btn btn-primary px-5" href="../../VgmsModules/Prms/add_proposal.php">
                            <i class="fa-solid fa-plus me-2"></i>Add new proposal</a></div>
                </div>
                                ...
                                <div
                                    ...
                                    <div class="avatar-group"><a
                                            ...
                                            <div class="avatar avatar-m  rounded-circle">
                                                <img class="rounded-circle " src="../../assets/img/team/34.webp"
                                                    alt="" />
                                            </div>
                                        </a>
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden"
                                            ...
                                            data-bs-auto-close="outside">
                                            <div class="avatar avatar-m  rounded-circle">
                                                <img class="rounded-circle " src="../../assets/img/team/59.webp"
                                                    alt="" />
                                            </div>
                                        </a>
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden"
                                            ...
                                            data-bs-auto-close="outside">
                                            <div class="avatar avatar-m  rounded-circle">
                                                <img class="rounded-circle " src="../../assets/img/team/35.webp"
                                                    alt="" />
                                            </div>
                                        </a>
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden"
                                            ...
                                            data-bs-auto-close="outside">
                                            <div class="avatar avatar-m  rounded-circle">
                                                <img class="rounded-circle " src="../../assets/img/team/58.webp"
                                                    alt="" />
                                            </div>
                                        </a>
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden"
                                    ...
                                    <div class="mt-lg-3 mt-xl-0"> <i class="fa-solid fa-list-check me-1"></i>
                                        <p class="d-inline-block fw-bold mb-0">287<span class="fw-normal"> Task</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card h-100 hover-actions-trigger">
                            <div class="card-body">
                                ...
                                <div class="progress bg-primary-subtle">
                                    <div class="progress-bar rounded bg-primary" role="progressbar"
                                        aria-label="Success example" style="width: 89%" aria-valuenow="25"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <div class="d-flex align-items-center mt-4">
                                    <p class="mb-0 fw-bold fs-9">Started :<span
                                ...
                                <div
                                    ...
                                    <div class="mt-lg-3 mt-xl-0"> <i class="fa-solid fa-list-check me-1"></i>
                                        <p class="d-inline-block fw-bold mb-0">72<span class="fw-normal"> Task</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card h-100 hover-actions-trigger">
                            <div class="card-body">
                                ...
                                <div class="progress bg-danger-subtle">
                                    <div class="progress-bar rounded bg-danger" role="progressbar"
                                        aria-label="Success example" style="width: 15%" aria-valuenow="25"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <div class="d-flex align-items-center mt-4">
                                    <p class="mb-0 fw-bold fs-9">Started :<span
                                ...
                                <div
                                    ...
                                    <div class="avatar-group"><a
                                            ...
                                            data-bs-auto-close="outside">
                                            <div class="avatar avatar-m  rounded-circle">
                                                <img class="rounded-circle " src="../../assets/img/team/11.webp"
                                                    alt="" />
                                            </div>
                                        </a>
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden"
                                            ...
                                            data-bs-auto-close="outside">
                                            <div class="avatar avatar-m  rounded-circle">
                                                <img class="rounded-circle " src="../../assets/img/team/12.webp"
                                                    alt="" />
                                            </div>
                                        </a>
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden"
                                            ...
                                            data-bs-auto-close="outside">
                                            <div class="avatar avatar-m  rounded-circle">
                                                <img class="rounded-circle " src="../../assets/img/team/13.webp"
                                                    alt="" />
                                            </div>
                                        </a>
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden"
                                    ...
                                    <div class="mt-lg-3 mt-xl-0"> <i class="fa-solid fa-list-check me-1"></i>
                                        <p class="d-inline-block fw-bold mb-0">91<span class="fw-normal"> Task</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div
                                    ...
                                    <div class="avatar-group"><a
                                        ...
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden"
                                            ...
                                            data-bs-auto-close="outside">
                                            <div class="avatar avatar-m  rounded-circle">
                                                <img class="rounded-circle " src="../../assets/img/team/16.webp"
                                                    alt="" />
                                            </div>
                                        </a>
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden"
                                            ...
                                            data-bs-auto-close="outside">
                                            <div class="avatar avatar-m  rounded-circle">
                                                <img class="rounded-circle " src="../../assets/img/team/18.webp"
                                                    alt="" />
                                            </div>
                                        </a>
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden"
                                    ...
                                    <div class="mt-lg-3 mt-xl-0"> <i class="fa-solid fa-list-check me-1"></i>
                                        <p class="d-inline-block fw-bold mb-0">134<span class="fw-normal"> Task</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="progress bg-body-secondary">
                                    <div class="progress-bar rounded bg-secondary-darker" role="progressbar"
                                        aria-label="Success example" style="width: 32%" aria-valuenow="25"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <div class="d-flex align-items-center mt-4">
                                    <p class="mb-0 fw-bold fs-9">Started :<span
                                ...
                                <div
                                    ...
                                    <div class="avatar-group"><a
                                            ...
                                            data-bs-auto-close="outside">
                                            <div class="avatar avatar-m  rounded-circle">
                                                <img class="rounded-circle " src="../../assets/img/team/31.webp"
                                                    alt="" />
                                            </div>
                                        </a>
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden"
                                            ...
                                            data-bs-auto-close="outside">
                                            <div class="avatar avatar-m  rounded-circle">
                                                <img class="rounded-circle " src="../../assets/img/team/33.webp"
                                                    alt="" />
                                            </div>
                                        </a>
                                        <div class="dropdown-menu avatar-dropdown-menu p-0 overflow-hidden"
                                    ...
                                    <div class="mt-lg-3 mt-xl-0"> <i class="fa-solid fa-list-check me-1"></i>
                                        <p class="d-inline-block fw-bold mb-0">28<span class="fw-normal"> Task</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        gsap.from(".row.mb-4 .col-12, .row.mb-4 .col-sm-auto", {
            opacity: 0,
            y: 40,
            duration: 0.6,
            stagger: 0.2,
