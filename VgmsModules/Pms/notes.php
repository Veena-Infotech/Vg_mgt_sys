                                    ...
                                    <form>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select" id="noteTag" required>
                                            ...
                                            <div class="col-md-6 form-check">
                                                <input type="checkbox" class="form-check-input" id="archiveNote">
                            ...
                            <div class="modal-content">
                                <form>
                                    ...
                                    <div class="modal-body row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="date" class="form-control" id="editNoteDate"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-floating">
                                                <textarea class="form-control" id="editNoteDescription"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <select class="form-select" id="editNoteTag" required>
                                                    <option selected disabled>Choose Tag</option>
                                                    <option value="To-Do">To-Do</option>
                                                    <option value="In Progress">In Progress</option>
                                                    <option value="Completed">Completed</option>
                                        ...
                                        <div class="col-md-6 form-check">
                                            <input type="checkbox" class="form-check-input" id="editArchiveNote">
