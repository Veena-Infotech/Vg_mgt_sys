...
<body>
    ...
    <main class="main" id="top">
        ...
        <div class="content">
            ...
            <div id="headerSection" class="text-start mb-4">
                <h1 class="fw-bold">My Attendance</h1>
                <p class="lead text-muted">View and monitor your attendance records with ease.</p>
            </div>
            <hr class="hr" />
    ...
    <div class="form-floating form-floating-advance-select mb-3">
        <label for="currentDateTime">Current Date & Time (IST)</label>
        <input type="text" class="form-control" id="currentDateTime" placeholder="Current Date & Time" readonly>
    </div>
</div>
...
<script>
    // Function to display the current date and time in IST format
...
// Initial call to display the date and time on page load
updateDateTime();
