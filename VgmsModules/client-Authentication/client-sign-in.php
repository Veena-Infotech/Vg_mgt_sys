              ...
              <div class="row align-items-center gx-0 gy-7">
                <div
                  ...
                  <div
                    ...
                    <p class="text-body-tertiary">Whether you're driving innovation with us or expanding your vision —
                  ...
                  <div class="position-relative z-n1 mb-6 d-none d-md-block text-center mt-md-15"><img
                      class="auth-title-box-img d-dark-none" src="../../assets/img/spot-illustrations/auth.png" alt="" /><img
                      class="auth-title-box-img d-light-none" src="../../assets/img/spot-illustrations/auth-dark.png"
                      alt="" /></div>
                </div>
                <div class="col mx-auto">
                  <div class="auth-form-box">
                    <div class="text-center mb-7 w-100"><a class="d-flex flex-center text-decoration-none mb-4"
                        href="index.html">
                        <div class="w-100" style="max-width: 300px;">
                          <img src="../../assets/img/logos/logo.png" alt="phoenix" class="img-fluid" />
                        </div>
                      </a>
                      ...
                      <form action="verify-client.php" method="post">
