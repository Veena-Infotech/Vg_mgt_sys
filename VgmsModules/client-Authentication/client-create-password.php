                            ...
                            <div class="row align-items-center gx-0 gy-7">
                                <div
                                    ...
                                    <div
                                        ...
                                        <h3 class="mb-3 text-body-emphasis fs-7">Veena Group Client Hub</h3>
                                ...
                                <div class="col mx-auto">
                                    <div class="auth-form-box">
                                        <div class="text-center mb-7 w-100"><a
                                                class="d-flex flex-center text-decoration-none mb-4" href="https://www.theveenagroup.com/">
                                                <div class="w-100" style="max-width: 300px;">
                                                    <img src="../../assets/img/logos/logo.png" alt="phoenix"
                                                        class="img-fluid" />
                                                </div>
                                            </a>
                                            <h3 class="text-body-highlight">Create a Password</h3>
                                            <p class="text-body-tertiary">Set your password to access your account.</p>
                                            ...
                                            <form action="" method="post">
                                                <div class="mb-3 text-start"><label class="form-label" for="email">Email
                                                    ...
                                                    <div class="form-icon-container"><input
                                                            class="form-control form-icon-input" id="email" type="email"
                                                            name="email" placeholder="name@example.com" readonly /><span
                                                ...
                                                </div><button class="btn btn-primary w-100 mb-3">create
                                                    password</button>
                                            </form>
                                        </div>
                                    </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            confirmPasswordInput.addEventListener("input", function() {
                ...
                if (confirmPassword && password !== confirmPassword) {
                    ...
                    confirmPasswordInput.style.border = ""; // Reset to default
                }
            });
        });
    </script>
