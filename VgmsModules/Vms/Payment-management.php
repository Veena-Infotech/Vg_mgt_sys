...
<body>
    ...
    <main class="main" id="top">
        ...
        <div class="content">
            ...
            <p class="text-muted mb-3">List of all completed and pending payments</p>
            <hr class="hr" /><br>
            <div id="tableExample3"
            data-list='{"valueNames":["number", "name", "service", "date", "time","amt","paymethod"], "page":5, "pagination":true}'>
                    ...
                    <table class="table table-striped table-sm fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="sort border-top" data-sort="service">Service</th>
                                <th class="sort border-top" data-sort="date">Date</th>
                                <th class="sort border-top" data-sort="time">Time</th>
                                <th class="sort border-top" data-sort="amt">Amount</th>
                                <th class="sort border-top" data-sort="paymethod">Payment method</th>
                        ...
                        <tbody class="list">
                            <tr>
                                ...
                                <td class="align-middle name">akash</td>
                                <td class="align-middle service">Workshop</td>
                                <td class="align-middle date">30 April 2025</td>
                                <td class="align-middle time">11.00 AM</td>
                                <td class="align-middle amt">₹1000</td>
                                <td class="align-middle paymethod">UPI</td>
                                ...
                                <td class="align-middle white-space-nowrap text-end pe-0">
                                    <div class="btn-reveal-trigger position-static"><button
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end py-2" style=""><a
                                                class="dropdown-item" href="#!">View Receipt</a><a class="dropdown-item"
                                                href="#!">Reminder</a>
