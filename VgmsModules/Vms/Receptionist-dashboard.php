...
<body>
    ...
    <main class="main" id="top">
        ...
        <div class="content">
        <h2 class="mb-2 lh-sm">Receptionist dashboard </h2>
        <h5 class="mb-2 lh-sm">Meeting Schedule</h5>
        <h5 class="mb-2 lh-sm">3 May 2025</h5>
        <div id="tableExample3" data-list="{&quot;valueNames&quot;:[&quot;name&quot;,&quot;email&quot;,&quot;age&quot;],&quot;page&quot;:5,&quot;pagination&quot;:true}">
                          ...
                          <table class="table table-striped table-sm fs-9 mb-0">
                            ...
                            <tbody class="list">
                              <tr>
                                ...
                                <div class="badge badge-phoenix fs-10 badge-phoenix-warning"><span class="fw-bold">Waiting</span><span class="ms-1 fas fa-stream"></span></div>
                                </td>
                                <td class="align-middle white-space-nowrap text-end pe-0">
                                  <div class="btn-reveal-trigger position-static"><button class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><svg class="svg-inline--fa fa-ellipsis fs-10" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M8 256a56 56 0 1 1 112 0A56 56 0 1 1 8 256zm160 0a56 56 0 1 1 112 0 56 56 0 1 1 -112 0zm216-56a56 56 0 1 1 0 112 56 56 0 1 1 0-112z"></path></svg><!-- <span class="fas fa-ellipsis-h fs-10"></span> Font Awesome fontawesome.com --></button>
                                    <div class="dropdown-menu dropdown-menu-end py-2" style=""><a class="dropdown-item" href="#!">Completed</a><a class="dropdown-item" href="#!">Reschedule</a>
                              ...
                              <tr>
                                <td class="align-middle ps-3 name">1</td>
                                <td class="align-middle name">Mr.akash</td>
                                <td class="align-middle name">Mr.Raj</td>
                                <td class="align-middle meeting">Office Visit</td>
                                <td class="align-middle time">11.00 AM</td>
                                <td class="align-middle status">
                        ...
                        <div class="d-flex justify-content-between mt-3"><span class="d-none d-sm-inline-block" data-list-info="data-list-info">1 to 5 <span class="text-body-tertiary"> Items of </span>43</span><a href="/VGMS/Vg_mgt_sys/VgmsModules/Vms/Visitor-Meeting-History.php">View History</a>
