                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="amountInput" name="amount" placeholder="Enter amount">
                                        </div>

                                        <div class="mb-3">
                                            <label for="descriptionInput" class="form-label">Description</label>
                                            <textarea class="form-control" id="descriptionInput" name="description" rows="3" placeholder="Enter description"></textarea>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="stageSelect" class="form-label">Stage</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="probabilitySelect" class="form-label">Probability %</label>
                                            <select class="form-select" id="probabilitySelect" name="probability">
                                                <option selected disabled>Select probability</option>
                                        ...
                                        <div class="mb-3">
                                            <label for="forecastCategorySelect" class="form-label">Forecast Category</label>
                                            <select class="form-select" id="forecastCategorySelect" name="forecast_category">
                                        ...
                                        <div class="mb-3">
                                            <label for="nextStepInput" class="form-label">Next Step</label>
                                            <input type="text" class="form-control" id="nextStepInput" name="next_step" placeholder="Enter next step">
                                        </div>
                                    </form>
                                </div>
                        ...
                        <table class="table table-striped table-sm fs-9 mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort border-top" data-sort="stage">Stage</th>
                                    <th class="sort border-top" data-sort="close-date">Close Date</th>
                            ...
                            <tbody class="list">
                                <tr>
                                    <td class="align-middle ps-3 name">Alpha Corp</td>
                                    <td class="align-middle account">AC1001</td>
                                    <td class="align-middle stage">Prospecting</td>
                                    <td class="align-middle close-date">2025-06-10</td>
                                    <td class="align-middle owner">John Doe</td>
                            ...
                            <div class="modal-body">
                                <form id="editCaseForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="editNameInput" name="name" placeholder="Enter name">
                                    </div>

                                    <div class="mb-3">
                                        <label for="editAccountSelect" class="form-label">Account</label>
                                        <select class="form-select" id="editAccountSelect" name="account">
                                            <option selected disabled>Choose Account</option>
                                            <option value="Alpha Corp">Alpha Corp</option>
                                            <option value="Beta Inc">Beta Inc</option>
                                            <option value="Gamma Ltd">Gamma Ltd</option>
                                    ...
                                    <div class="mb-3">
                                        <label for="editStageSelect" class="form-label">Stage</label>
                                        <select class="form-select" id="editStageSelect" name="stage">
                                            <option selected disabled>Choose Stage</option>
                                            <option value="Prospecting">Prospecting</option>
                                            <option value="Qualification">Qualification</option>
                                            <option value="Proposal">Proposal</option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="editAmountInput" name="amount" placeholder="Enter amount">
                                    </div>
                                    <div class="mb-3">
