...
<body>
    ...
    <main class="main" id="top">
        ...
        <div class="content">
            <h2 class="text-center fw-bold mb-4">Manage-Role</h2>
            <hr>
            ...
            <div id="tableExample3" data-list="{&quot;valueNames&quot;:[&quot;name&quot;,&quot;email&quot;,&quot;age&quot;],&quot;page&quot;:10,&quot;pagination&quot;:true}">
                ...
                <div class="table-responsive">
                    <table id="tableExample5"  class="table table-striped table-sm fs-9 mb-0">
                        <thead>
                            <tr>
                                <th class="sort border-top border-translucent ps-3" data-sort="srn">SRN</th>
                        ...
                        <tbody class="list">
                            <tr>
                                <td class="align-middle ps-3 srn">101</td> <!-- SRN added -->
                                <td class="align-middle name">Anna</td>
                                <td class="align-middle email">anna@example.com</td>
                                <td class="align-middle role">
                                    <span class="badge badge-phoenix badge-phoenix-secondary">student</span>
                                </td>
                                <td class="align-middle white-space-nowrap text-end pe-0">
                                    <button class="btn btn-outline-secondary me-1 mb-1" type="button" data-bs-toggle="modal" data-bs-target="#manageRoleModal">
                                        Manage Role
                                    </button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="manageRoleModalLabel">Manage User Role</h5>
