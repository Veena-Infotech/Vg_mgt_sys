                ...
                <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                        <div class="col-12 col-md">
                            <h4 class="text-body mb-0" data-anchor="data-anchor">Interview Scheduling</h4>
                        </div>
                    </div>
                </div>
...
&lt;/form&gt;</code></pre>
                    ...
                    <div class="p-4 code-to-copy">
                        <form class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label" for="InterviewID">Interview ID</label>
                                <input class="form-control" id="" type="text" />
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="InterviewID">Candidate ID</label>
                                <input class="form-control" id="" type="text" />
                            </div>
                            <div class="col-md-6 ml-3 mt-3">
                                <label class="form-label" for="datepicker2">Posting Date</label>
                                <input class="form-control" id="datepicker2" type="text" placeholder="dd/mm/yyyy"
                                    required>
                                <div class="invalid-feedback">Please select a valid date (today or later).</div>
                            </div>
                            <div class="col-md-6 ml-3 mt-3">
                                <label class="form-label" for="timepicker1">Interview Time</label>
                                <input class="form-control datetimepicker" id="timepicker1" type="text"
                                    placeholder="hour : minute"
                                    data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}' />
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" for="inputState">Interview Mode</label>
                                <select class="form-select" id="inputState">
                                    <option selected="selected">Choose...</option>
                                    <option>...</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                <label class="form-label" for="inputState">Interviewers Assigned</label>
                                <select class="form-select" id="inputState">
                                    <option selected="selected">Options </option>
                                    <option selected="selected">Options </option>
                                    <option selected="selected">Options </option>
                                    <option selected="selected">Options </option>
                                    <option selected="selected">Options </option>Options <option>...</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-2">
                                <label class="form-label" for="inputZip"> Location/Link</label>
                                <input class="form-control" id="inputZip" type="text" />
                            </div>
                            <div class="col-12">
